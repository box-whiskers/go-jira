...
func (s *IssueServiceImpl) GetCreateMeta(projectkeys string) (*CreateMetaInfo, *Response, error) {
...
func (s *IssueServiceImpl) GetCreateMetaWithOptions(options *GetQueryOptions) (*CreateMetaInfo, *Response, error) {
